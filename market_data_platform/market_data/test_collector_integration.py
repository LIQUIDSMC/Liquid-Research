...
from market_data_platform.market_data import collector
from market_data_platform.market_data import storage
from market_data_platform.market_data.buffer import RecordBuffer
...
def test_no_production_canonical_path_touched():
    real_production_path = "data/market_data_platform/canonical"
