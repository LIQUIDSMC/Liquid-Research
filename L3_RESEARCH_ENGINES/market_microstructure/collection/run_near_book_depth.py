...
from L3_RESEARCH_ENGINES.market_microstructure.indicators.near_book_depth import compute_near_book_obi
from rich.console import Console
from rich.table import Table

console = Console()

LOG_PATH = os.path.join("L3_RESEARCH_ENGINES", "market_microstructure", "data", "near_book_depth_log.csv")
LOG_COLUMNS = [
