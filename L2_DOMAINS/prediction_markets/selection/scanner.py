...
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "market_data"))
...
MARKETS_DIR = "L2_DOMAINS/prediction_markets/data/markets"
SCANNER_OUTPUT_DIR = "L2_DOMAINS/prediction_markets/data/scanner"
