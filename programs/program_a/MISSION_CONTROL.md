...
## Performance (closed trades only — calculated from paper_trades.csv, 2026-07-16)
⚠️ Still far from conclusive at n=52. Do not over-interpret.
Win rate: 84.6%
Total realized P&L: $115.06
